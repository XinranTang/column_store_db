...
-- SELECT avg(col1+col2), min(col2), max(col3), avg(col3-col2), sum(col3-col2) FROM tbl2 WHERE (col1 >= 43 AND col1 < 359) AND (col2 >= -325 AND col2 < -9);
s1=select(db1.tbl2.col1,43,359)
sf1=fetch(db1.tbl2.col2,s1)
s2=select(s1,sf1,-325,-9)
